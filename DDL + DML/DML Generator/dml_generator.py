...
# Genre
with open('genre.txt','w', encoding='utf-8') as genre_file:
...
# Show
with open('shows.txt', 'w', encoding='utf-8') as show_file:
...
# Actor
with open('actors.txt', 'w', encoding='utf-8') as actor_file:
...
# ShowGenre
with open('showgenre.txt', 'w', encoding='utf-8') as showgenre_file:
